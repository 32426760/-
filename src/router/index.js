...
import DesignFile from "@/views/designFile.vue";
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: "/designFile", name: "DesignFile", component: DesignFile },
      {
      ...
      { path: "/customerReconciliationAndCollection", name: "CustomerReconciliationAndCollection", component: CustomerReconciliationAndCollection },
